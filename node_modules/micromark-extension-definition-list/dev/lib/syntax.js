...
function resolveDefinitionTermTo(defListStartIndex, events) {
    ...
    let newDefListStartIndex = createDefTermEvent(events, flowIndex, defListStartIndex, blockQuoteExit != null);
    // put blockQuote exit
    if (blockQuoteExitIndex != null) {
...
function checkPossibleDefTerm(events) {
    ...
    if (flowEvents != null && termFlowStart != null) {
        ...
        for (let i = flowEvents.length - 1; i >= 0; i--) {
            ...
            if (tmpToken.type !== types.lineEnding &&
                ...
                return (tmpToken.type === types.paragraph ||
...
function tokenizeDefListContinuation(effects, ok, nok) {
    ...
    function onBlank(code) {
        ...
        self.containerState.furtherBlankLines =
            (_a = self.containerState.furtherBlankLines) !== null && _a !== void 0 ? _a : self.containerState.initialBlankLine;
    ...
    function notBlank(code) {
        ...
        if ((_a = self.containerState.furtherBlankLines) !== null && _a !== void 0 ? _a : !markdownSpace(code)) {
    ...
    function notInCurrentItem(code) {
        ...
        return factorySpace(effects, effects.attempt(defListConstruct, ok, nok), types.linePrefix, self.parser.constructs.disable.null != null &&
...
function tokenizeDefListDescriptionPrefixWhitespace(effects, ok, nok) {
    const self = this; // eslint-disable-line @typescript-eslint/no-this-alias
    return factorySpace(effects, afterPrefix, tokenTypes.defListDescriptionPrefixWhitespace, self.parser.constructs.disable.null != null &&
        self.parser.constructs.disable.null.includes('codeIndented')
        ? undefined
        : constants.tabSize + 1);
    function afterPrefix(code) {
