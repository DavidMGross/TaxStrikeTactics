...
Small businesses there learned how they could use similar methods, and then they implemented them to avoid their taxes.
...
Opportunities for legal tax avoidance (or even better, tax <em>reversal</em>) may be unusual and counterintuitive.
For a while, in Sweden, some people were deliberately <em>overpaying</em> their federal taxes.
Why?
Interest rates had fallen below 0%, but the government was pledged to pay 0.56% interest on tax overpayments.
So if you overpay the government, the government ends up poorer and you end up richer.
