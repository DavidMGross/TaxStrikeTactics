...
Tax resistance campaigns can amplidy their impact by encouraging bank runs—that is, by asking people to withdraw their savings from banks.
This can reduce the assets available to the government, or can crash the economic system and thereby pressure the government more indirectly.

If the government forbids people from withdrawing their own money, or is unable to meet the sudden demand for currency, this threatens the credibility of the banking system, which can make it difficult for the regime to continue in business.
...
The government may respond to such a crisis by further degrading the currency, but the long-term effects of this can also undermine the government.

## <Badge text="Example" size="medium" /> Reform Act Agitation

In the final days of the agitation in the United Kingdom that led to the Reform Act 1832, the movement in favor of the Act augmented its tax resistance campaign with a run on the Bank of England.
London awoke one morning to find that the resistance movement had plastered the walls of the city with posters reading *“Go for Gold!”*
...
Some war tax resisters avoid depositing money in banks, but more as a boycott than a bank run—because banks operate as war financiers, because bank deposits are especially vulnerable to government seizure, and because the profits of banks are taxable.

The “Move Our Money” project claims it convinced Americans to shift more than half a billion dollars of their savings from banks to credit unions:
...
[Move Our Money USA](https://www.moveourmoneyusa.org/)
</Aside>

## <Badge text="Example" size="medium" /> Enric Durán

Enric Durán of the Spanish <i lang="es">indignados</i> movement was a one-man bank run.
...
<Aside type="tip" title="Wikipedia">
  <WikipediaBadge title="Bank run" />
  <WikipediaBadge title="Financial crisis" />
  <WikipediaBadge title="Reform Act 1832" />
  <WikipediaBadge title="Bank Transfer Day" />
  <WikipediaBadge title="Enric Duran" />
  <WikipediaBadge title="Anti-austerity movement in Spain" />
</Aside>
---
