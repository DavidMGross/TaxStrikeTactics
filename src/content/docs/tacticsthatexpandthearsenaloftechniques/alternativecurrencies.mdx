...
Wikipedia: [Time-based currency](https://en.wikipedia.org/wiki/Time-based_currency)
</Aside>
...
<Aside type="tip" title="Links">
Wikipedia: [EverQuest](https://en.wikipedia.org/wiki/EverQuest), [Ultima Online](https://en.wikipedia.org/wiki/Ultima_Online), [Tencent QQ](https://en.wikipedia.org/wiki/Tencent_QQ)
</Aside>
...
<Aside type="tip" title="Links">
Wikipedia: [Liberty dollar (private currency)](https://en.wikipedia.org/wiki/Liberty_dollar_(private_currency))
</Aside>
