...
The movement opened its own supermarket—“Punto Pizzofree”—that stocks products only from suppliers who have pledged to resist the <i>pizzo</i>.
It also held annual “Critical Consumption” street fairs that highlight resisting businesses.
If you’d like to take a look for yourself, you can pay a visit under the auspices of [Addiopizzo Travel](https://www.addiopizzotravel.it/), which runs pizzo-free tours.

## <Badge text="Example" size="medium" /> Poll Tax Rebellion

The <em>threat</em> of a boycott, if credible and well-timed, can also be effective.
