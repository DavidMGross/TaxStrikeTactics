...
<Aside type="tip" title="Wikipedia">
  <WikipediaBadge title="Reconstruction in South Carolina" />
  <WikipediaBadge title="George Trenholm" />
  <WikipediaBadge title="Odious debt" />
  <WikipediaBadge title="Sovereign default" />
</Aside>
