...
People are more willing to risk the wrath of the government in a tax resistance campaign if they know the weight of that wrath will not fall wholly on them.
One way your campaign can provide this reassurance is by forming a mutual insurance plan, so that if the government retaliates against a resister that person won’t have to bear the consequences alone.
...
American war tax resisters organize what they call “penalty funds.”
...
For example, the [“War Tax Resisters Penalty Fund”](https://nwtrcc.org/wtrpf/) works this way:
If the IRS successfully seizes resisted taxes from a war tax resister, the resister notifies the Fund about the seizure and sends documentation that shows what portion of what was seized can be attributed to penalties & interest (the portion that was not simply the taxes that the resister had originally refused to pay).
...
This helps give courage to American war tax resisters who might otherwise be intimidated by the financial impact of penalties & interest.
...
Campaigns that organize mutual insurance plans may have to make tough decisions about how the plans are funded and used—for instance, whether the insurance will benefit all resisters, or only those resisters who are also contributors to the mutual insurance fund.
