...
sidebar:
  order: 9
---
When you embark on your personal revolution, you may feel alone, but you should expect to find company.
...
Thoreau believed that only by pursuing the solitary revolution would it be possible to cooperate with other people in a more than superficial way:
