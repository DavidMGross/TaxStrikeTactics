...
Also, some protesters are forced into positions of powerless inferiority and then have no recourse but to use petulant tactics that are appropriate to such a position—for instance, the [Irish prisoners](https://en.wikipedia.org/wiki/1981_Irish_hunger_strike) who used tactics like hunger strikes or smearing the walls of their cells with feces.
...
For example, [the lunch counter sit-ins](https://en.wikipedia.org/wiki/Sit-in_movement) during the American civil rights movement were done in a dignified way:
...
First, acknowledge that the temptation exists, and that it springs from protesters’ feelings of inferiority with respect to the protest target.
...
Second, examine protest tactics to discern to what extent they use petulance.
...
* Gandhi counseled:
  ...
  ― <i>Young India</i> Vol. I; pp. 65–66
