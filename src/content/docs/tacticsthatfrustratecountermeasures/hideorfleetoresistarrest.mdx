...
But if the resisters make a run for it when arrests are imminent, the government may have only multiplied its headaches.
...
Those judges risked being jailed on contempt of court charges for such refusal, so they took office with the understanding that they would spend their term either in jail or in hiding.
