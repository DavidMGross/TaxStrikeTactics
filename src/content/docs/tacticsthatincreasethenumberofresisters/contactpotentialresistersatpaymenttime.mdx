...
One way to spread the tax resistance message, and to reach potential tax resisters when they may be most receptive to that message, is to propagandize them when and where they typically make their tax payments.

## <Badge text="Example" size="medium" /> American War Tax Resisters

This tactic was particularly prominent in the American war tax resistance movement, which often conducted demonstrations and other outreach activities at post offices and IRS buildings on “tax day,” the day when annual income tax returns are due.
...
* Two dozen war tax resisters in St. Louis, Missouri, propagandized taxpayers on tax day in 2003 by creating their own tax forms.
...
* In Portland, Oregon, war tax resisters held up a series of signs along the roadside that, in the fashion of [the old “Burma Shave” billboards](https://en.wikipedia.org/wiki/Burma-Shave#Roadside_billboards), spelled out rhyming messages:
