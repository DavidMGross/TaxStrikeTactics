...
a sort of [chain letter](https://en.wikipedia.org/wiki/Chain_letter) in which she sent out letters that advocated tax resistance (and that protested on behalf of an imprisoned resister) and that asked the recipients to send the same letter “to at least three friends.”
...
* Burns, Danny “Bristol and Avon—the story so far” <i>3D</i> #1 (c. November 1989) p. 3
