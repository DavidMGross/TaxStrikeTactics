...
The Internal Revenue Service (IRS) tried to enforce the law by seizing money directly from resisters’ bank accounts.
...
Occasionally something similar happens today, when because a tax resister has so few assets, or those assets would take too much trouble to discover, the Internal Revenue Service marks the resister’s file as “uncollectible” and gives up the attempt to force payment.
...
Sometimes tax resistance is “legalized” by means of a conflict between rival governments or branches of government.
...
* “MSPs vote to end poll tax debt collections” <i>BBC News</i> 19 February 2015
