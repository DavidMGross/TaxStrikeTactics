...
<Aside type="wikipedia" title="Wikipedia">
  ...
  <WikipediaBadge title="Ship money" />
  <WikipediaBadge title="Ship Money Act 1640" />
  <WikipediaBadge title="Amish" />
  <WikipediaBadge title="United States v. Lee (1982)" />
  ...
  <WikipediaBadge title="Eight per thousand" />
  <WikipediaBadge title="Norges Fredsfond" url="https://no.wikipedia.org/wiki/Norges_Fredsfond" />
  <WikipediaBadge title="Joshua Evans (Quaker minister)" />
  <WikipediaBadge title="Sarah E. Wall" />
  ...
  <WikipediaBadge title="True Sun (London newspaper)" />
  <WikipediaBadge title="Alassane Ouattara" />
</Aside>
...
* Evans, Joshua “A Drop in the Ocean” <i>American Quaker War Tax Resistance</i>, 2nd ed. (2011) pp. 79–80 [<i>A Journal of the Life, Travels, Religious Exercises, and Labours in the Work of the Ministry of Joshua Evans</i> (1837) [pp. 19–21](https://archive.org/details/journaloflifetra00evan/page/19/mode/1up)]
