---
title: Tactics that Lay the Groundwork for Victory
...
It can be helpful to imagine a variety of victory scenarios for your campaign.
By keeping your eyes on your destination, you can be more confident that you’re travelling in the right direction.

This chapter considers three common varieties of victorious end-game scenarios for such tax resistance campaigns:
...
: In some cases, people realize that they can refuse a tax—or set their own terms for how and how much of it will be collected—without any need for a change in the laws.
...
In the following chapter, [“The Revolution Is Within You,”](../../therevolutioniswithinyou/introduction/) I consider a different sort of victory scenario entirely—one in which individual tax resisters fight and win their own solitary revolutions.
