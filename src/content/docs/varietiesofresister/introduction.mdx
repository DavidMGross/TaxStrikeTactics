...
For example, tax resisters in the movement that pressed for the Reform Act of 1832 in the U.K. wanted to “stop the supplies”—that is, to withhold enough money from the government that it would be crippled and would be forced to grant the movement’s demands.
